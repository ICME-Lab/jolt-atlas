...
pub enum LowerWordNoMsbPrefix2<const XLEN: usize> {}

impl<const XLEN: usize, F: JoltField> SparseDensePrefix<F> for LowerWordNoMsbPrefix2<XLEN> {
    fn prefix_mle<C>(
    ...
    {
        let mut word = checkpoints[Prefixes::LowerWordNoMsb2].unwrap_or(F::zero());
