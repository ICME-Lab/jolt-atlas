...
def main() -> None:
    ...
    parser.add_argument(
        "--activation-stats",
        default="qwen3-awy/calibration/activation_stats_128.json",
    )
    parser.add_argument(
        "--model",
        default="qwen3-awy/models/qwen3-0.6b/model.safetensors",
    )
    parser.add_argument(
        "--output",
        default="qwen3-awy/calibration/smoothquant_scales_alpha_0_5.json",
    )
