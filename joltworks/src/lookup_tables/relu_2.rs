...
impl<const X_LEN: usize> PrefixSuffixDecompositionTrait<X_LEN> for ReluTable<X_LEN> {
    fn suffixes(&self) -> Vec<Suffixes> {
        vec![Suffixes::One, Suffixes::LowerWordNoMSB2]
    }

    fn prefixes(&self) -> Vec<Prefixes> {
        vec![Prefixes::NotMsb2, Prefixes::LowerWordNoMsb2]
    }
    ...
    fn combine_test<F: JoltField>(
        ...
        prefixes[Prefixes::NotMsb2] * prefixes[Prefixes::LowerWordNoMsb2] * one
            + relu * prefixes[Prefixes::NotMsb2]
    }
...
mod test {
    ...
    #[test]
    fn prefix_suffix() {
        prefix_suffix_test_2::<32, Fr, ReluTable<32>>();
    }
