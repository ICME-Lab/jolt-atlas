...
pub fn lookup_table_mle_random_test<F: JoltField, T: AtlasLookupTable + Default>() {
...
pub fn lookup_table_mle_full_hypercube_test<F: JoltField, T: AtlasLookupTable + Default>() {
