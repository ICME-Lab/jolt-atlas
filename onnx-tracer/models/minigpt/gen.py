...
def export_to_onnx():
    ...
    vocab_size = 1024   # power of 2, close to the script's 28 (27 chars + BOS)
    n_embd = 32       # embedding dimension (script uses 16)
    n_head = 8        # attention heads (script uses 4)
    n_layer = 2       # transformer layers (script uses 1)
    block_size = 32   # sequence length (script uses 16)
