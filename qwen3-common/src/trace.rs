...
use crate::{FIXED_SCALE, FRAC_BITS, LayerShape};
...
#[derive(Debug, Clone)]
pub struct LayerRawWitness {
    pub hidden_out: Vec<i32>,
    pub residual_add_attn_a: Vec<i32>,
    pub down_proj: Vec<i32>,
    pub down_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub silu_up: Vec<i32>,
    pub silu_up_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub silu: Vec<i32>,
    pub silu_min_n: i64,
    pub silu_max_n: i64,
    pub silu_input_frac_bits: [Vec<u8>; FRAC_BITS],
    pub silu_lookup_ra: Vec<u8>,
    pub silu_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub gate_proj: Vec<i32>,
    pub gate_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub up_proj: Vec<i32>,
    pub up_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub rms_norm_mlp_sum_x2: Vec<i64>,
    pub rms_norm_mlp_norm: Vec<i32>,
    pub rms_norm_mlp_norm_frac_bits: [Vec<u8>; FRAC_BITS],
    pub rms_norm_mlp_a: Vec<i32>,
    pub rms_norm_mlp_b: Vec<i32>,
    pub rms_norm_mlp_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub hidden_in: Vec<i32>,
    pub residual_add_attn_b: Vec<i32>,
    pub o_proj: Vec<i32>,
    pub o_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub context: Vec<i32>,
    pub pv_matmul_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub softmax: Vec<i32>,
    pub softmax_acc: Vec<i64>,
    pub softmax_floor: Vec<i32>,
    pub softmax_floor_frac_bits: [Vec<u8>; FRAC_BITS],
    pub softmax_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub softmax_min_diff: i64,
    pub softmax_max_diff: i64,
    pub softmax_lookup_ra: Vec<u8>,
    pub softmax_exp_acc: Vec<i64>,
    pub softmax_exp_frac_bits: [Vec<u8>; FRAC_BITS],
    ...
    pub qk_score_dot_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub qk_score_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub q_rope: Vec<i32>,
    pub q_rope_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub k_rope: Vec<i32>,
    pub k_rope_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub q_norm_sum_x2: Vec<i64>,
    pub q_norm_norm: Vec<i32>,
    pub q_norm_norm_frac_bits: [Vec<u8>; FRAC_BITS],
    pub q_norm: Vec<i32>,
    pub q_norm_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub k_norm_sum_x2: Vec<i64>,
    pub k_norm_norm: Vec<i32>,
    pub k_norm_norm_frac_bits: [Vec<u8>; FRAC_BITS],
    pub k_norm: Vec<i32>,
    pub k_norm_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub q_proj: Vec<i32>,
    pub q_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub k_proj: Vec<i32>,
    pub k_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub v_proj: Vec<i32>,
    pub v_proj_output_frac_bits: [Vec<u8>; FRAC_BITS],
    pub rms_norm_atten_sum_x2: Vec<i64>,
    pub rms_norm_atten_norm: Vec<i32>,
    pub rms_norm_atten_norm_frac_bits: [Vec<u8>; FRAC_BITS],
    pub rms_norm_atten_a: Vec<i32>,
    pub rms_norm_atten_b: Vec<i32>,
    pub rms_norm_atten_c: Vec<i32>,
    pub rms_norm_atten_output_frac_bits: [Vec<u8>; FRAC_BITS],
}

pub struct TraceLayerRawInput {
...
pub fn layer_raw_input_from_trace_dir(
    trace_dir: impl AsRef<Path>,
    q8_cache: impl AsRef<Path>,
    layer: usize,
) -> Result<TraceLayerRawInput, TraceError> {
    ...
    let raw_witness = build_raw_witness_from_trace_dir(trace_dir, layer, &weights, shape)?;
    let hidden_out = raw_witness.hidden_out.clone();
    Ok(TraceLayerRawInput {
        shape,
        hidden_out,
        weights,
        raw_witness,
