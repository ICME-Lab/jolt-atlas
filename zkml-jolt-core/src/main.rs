...
// use zkml_jolt_core::benches::bench::{BenchType, benchmarks};
...
//             println!(
//                 "Running tracing-chrome. Files will be saved as trace-<some timestamp>.json and can be viewed in chrome://tracing."
//             );
//         }
//     }
