...
/// onnx-tracer currently supports.
///
/// # Usage
///
/// ```sh
/// # Simple model (no dynamic dimensions):
/// cargo run --example inspect_ops -- onnx-tracer/models/perceptron/network.onnx
///
/// # Model with dynamic dimensions (pass key=value pairs):
/// cargo run --example inspect_ops -- onnx-tracer/models/gpt2/model.onnx batch_size=1 sequence_length=16
/// ```
fn main() {
