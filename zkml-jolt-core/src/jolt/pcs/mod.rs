...
pub enum SumcheckId {
    ...
    WriteLookupOutputToTDVirtualization,
    SelectResVirtualization,
    SelectCondVirtualization,
    ...
    fn prepare_sumcheck(
        ...
        if self.polynomials.len() > 1 {
            ...
            debug_assert_eq!(
                ...
                self.polynomials[0], self.sumcheck_id,
            );
    ...
    F: JoltField,
{
    ...
    pub fn reduce_and_prove<ProofTranscript: Transcript, PCS: CommitmentScheme<Field = F>>(
        ...
        #[cfg(not(test))]
        {
            ...
            jolt_core::utils::thread::drop_in_background_thread(sumchecks);
        }
