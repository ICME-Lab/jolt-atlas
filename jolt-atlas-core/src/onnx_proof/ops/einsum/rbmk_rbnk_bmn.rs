    ...
    fn from_node(computation_node: &ComputationNode, einsum_dims: &EinsumDims) -> Self {
        ...
        match einsum.equation.as_str() {
            "abmk,abnk->abmn" => Self::AbmkAbnkAbmn {
                log_a: {
                    ...
                    assert_eq!(
                        ...
                        computation_node.padded_output_dims()[0] * computation_node.padded_output_dims()[1],
                    ...
                    computation_node.padded_output_dims()[0].log_2()
                },
                log_b: computation_node.padded_output_dims()[1].log_2(),
                log_m: computation_node.padded_output_dims()[2].log_2(),
                log_n: computation_node.padded_output_dims()[3].log_2(),
            ...
            "acbmk,kcn->cbmn" => Self::AcbmkKcnCbmn {
                ...
                log_c: computation_node.padded_output_dims()[0].log_2(),
                log_b: computation_node.padded_output_dims()[1].log_2(),
                log_m: computation_node.padded_output_dims()[2].log_2(),
                log_n: computation_node.padded_output_dims()[3].log_2(),
            ...
            "cbmk,cbkn->amn" => Self::CbmkCbknAmn {
                log_cb: {
                    assert!(
                        computation_node.padded_output_dims().len() == 3,
                        "cbmk,cbkn->amn expects a rank-3 output"
                    );
                    assert!(
                        computation_node.padded_output_dims()[0] == 1,
                ...
                log_m: computation_node.padded_output_dims()
                    [computation_node.padded_output_dims().len() - 2]
                    .log_2(),
                log_n: computation_node.padded_output_dims()
                    [computation_node.padded_output_dims().len() - 1]
                    .log_2(),
                log_k: einsum_dims.left_operand()[2].log_2(),
            },
